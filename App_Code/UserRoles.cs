...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection conML)
    {
    ...
    public static int InsertUserRoles(SqlConnection conML, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection conML, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection conML, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection conML, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection conML, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection conML, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection conML, UserRolesAccess cat)
    {
        int result = 0;
