...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection conML)
    {
    ...
    public static CreateUser GetUserDetails(SqlConnection conML, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection conML, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection conML, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection conML, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection conML, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection conML, string id,string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection conML, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection conML, CreateUser loginInputs)
    {
    ...
    public static CreateUser Login2(SqlConnection conML, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection conML, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection conML, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection conML, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection conML, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection conML, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection conML, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection conML, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection conML, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection conML, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection conML, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection conML, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection conML)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection conML, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(conML, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(conML, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(conML, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(conML, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(conML, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
