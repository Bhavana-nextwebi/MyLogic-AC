    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                CreateUser logins = CreateUser.Login(conML, inputs);
                if (logins.UserGuid != null)
                {
                    ...
                    else if (logins.Status == "Active")
                    {
                        ...
                        HttpCookie cookie = new HttpCookie("ml_aid");
                        cookie.Value = logins.UserGuid;

                        //this cookie is to validate password key
                        HttpCookie cookie_pass_key = new HttpCookie("ml_apkv");
                        ...
                        CreateUser.UpdateLastLoginTime(conML, logins.UserGuid);
