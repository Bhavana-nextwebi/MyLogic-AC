                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-6">
                                    <label>Blog URL / Slug <sup>*</sup></label>
                                    <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtUrl" ID="txtUrl" placeholder="Blog Url / Slug" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:TextBox runat="server" MaxLength="100" class="form-control mb-2 mr-sm-2 datepicker" ID="txtPosteddate" placeholder="Posted On" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPosteddate" Display="Dynamic" ForeColor="Red" SetFocusOnError="true" ValidationGroup="Save" ErrorMessage="Field can't be empty"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2" ID="txtPageTitle" placeholder="Page Title" />
                                </div>
                                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <small class="text-danger">.png, .jpeg, .jpg, .gif, .webp formats are required, Image Size Should be 1050 × 781 px</small><br />
                                </div>
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <small class="text-danger">.png, .jpeg, .jpg, .gif, .webp formats are required, Image Size Should be 1050 × 510 px</small><br />
                                </div>
